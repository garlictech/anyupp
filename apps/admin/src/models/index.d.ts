...
export declare class AdminUserRole {
  ...
  static copyOf(source: AdminUserRole, mutator: (draft: MutableModel<AdminUserRole>) => MutableModel<AdminUserRole> | void): AdminUserRole;
}
...
export declare class AdminUserSettings {
  ...
  static copyOf(source: AdminUserSettings, mutator: (draft: MutableModel<AdminUserSettings>) => MutableModel<AdminUserSettings> | void): AdminUserSettings;
}
