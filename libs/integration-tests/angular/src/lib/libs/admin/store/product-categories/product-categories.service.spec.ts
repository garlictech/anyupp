...
import { ProductCategoryCollectionService } from '@bgap/admin/refactor';
import {
...
describe('ProductCategoryCollectionService test', () => {
  let service: ProductCategoryCollectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ProductCategoryCollectionService);
  });
