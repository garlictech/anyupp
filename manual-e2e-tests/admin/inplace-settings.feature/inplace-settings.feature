Feature: In place settings on admin
    ...
    Scenario: admin assigned an in place modifier to a product
        Given I am on the dashboard as an authenticated superUser
        ...
        Then I should see "Sajtburger" text
        And On the active tab I click the edit button in the listitem with "Satjburger" content
        Then I should see "Edit product" text on the dialog
...
#As an AnyUPP unit staff administrator I can distinguish in-place orders on dashboard. (order queues, lanes, history)
