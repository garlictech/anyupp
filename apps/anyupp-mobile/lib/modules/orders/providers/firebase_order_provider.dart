...
// class FirebaseOrderProvider implements IOrdersProvider {
//   final DatabaseReference _dbRef;
//   final FirebaseAuthProvider _authProvider;
//   final FirebaseFunctionsProvider _firebaseFunctionsProvider;

//   FirebaseOrderProvider(this._dbRef, this._authProvider, this._firebaseFunctionsProvider);
...
//   DatabaseReference getRef(String chainId, String unitId, String userId) {
//     return _dbRef
//         .child('orders')
//         .child('chains')
//         .child(chainId)
...
//       'userLocation': {
//         'lat': unit
//             .address?.location?.latitude, // TODO ez tenyleg nem jo, thx Gyuri! Ide az user pozicioja kell, nem a unite
...
//     await this._firebaseFunctionsProvider.userPaymentIntentionSignal(chainId, unitId);
//   }
// }
