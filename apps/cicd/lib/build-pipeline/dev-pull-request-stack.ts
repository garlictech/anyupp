          ...
          phases: {
            ...
            build: {
              commands: [
                ...
                `yarn nx affected:lint --base=${stage} --with-deps ${generatedLibExcludes}`,
                `yarn nx affected:test --base=${stage} --with-deps --exclude="anyupp-mobile" --exclude="integration-tests-angular" --exclude="integration-tests-universal" ${generatedLibExcludes} --codeCoverage --coverageReporters=clover`,
              ],
            },
          },
          env: {
