...
class _CartScreenState extends State<CartScreen> {
  ...
  _handlePaymentButtonPressed(
    ...
    print('CartScreen._handlePaymentButtonPressed().place=$place');
    ...
    print('CartScreen._handlePaymentButtonPressed().place2=$place');

    if (place == null) {
      assert(place != null);
      print('CartScreen.Assert! place cannot by null');
      return;
    }
