...
import { ChainProductCollectionService } from '@bgap/admin/store/products';
import {
...
describe('ChainProductCollectionService test', () => {
  let service: ChainProductCollectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ChainProductCollectionService);
  });
