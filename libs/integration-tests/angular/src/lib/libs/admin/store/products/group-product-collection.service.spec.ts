...
import { GroupProductCollectionService } from '@bgap/admin/store/products';
import {
...
describe('GroupProductCollectionService test', () => {
  let service: GroupProductCollectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(GroupProductCollectionService);
  });
