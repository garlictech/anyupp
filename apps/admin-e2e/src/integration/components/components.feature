Feature: Create a new component
  ...
  Scenario: Create a new product component
    ...
    When I fill out the "Name (HU)" input with "test component 1 e2e"
    And I fill out the "Name (EN)" input with "test component 1 e2e"
    And I fill out the "Name (DE)" input with "test component 1 e2e"
    ...
    Then I should see "test component 1 e2e" text
    And I should see "test description" text

  Scenario: Update a product component
    When I click the edit button in the listitem with "test component 1 e2e" content
    Then The "Name (HU)" input should contain "test component 1 e2e"
    And The chain selector should contain "Rab lánc #1"
    When I fill out the "Name (HU)" input with "test component e2eUpdated 1"
    And I fill out the "Name (EN)" input with "test component e2eUpdated 1"
    And I fill out the "Name (DE)" input with "test component e2eUpdated 1"
    And I fill out the "Description" input with "test e2eUpdated description"
    And I click on the "8. Treenuts" checkbox
    And I click on the "9. Sulphites" checkbox
    And I click on the "10. Mustard" checkbox
    And I click on the "11. Celery" checkbox
    ...
    And I click on the "14. Molluscs" checkbox
    And I click on the "Submit" button
    Then I should see "test component e2eUpdated 1" text
  ...
  Scenario: Create an Extra component
    ...
    And I fill out the "Description" input with "test description"
    And I click the component selector to set "test component e2eUpdated 1"
  ...
  Scenario: Update an Extra
    ...
    Then The "Name (HU)" input should contain "test extra"
    And The chain selector should contain "Rab lánc #1"
    When I fill out the "Name (HU)" input with "test e2eUpdated extra"
    And I fill out the "Name (EN)" input with "test e2eUpdated extra"
    And I fill out the "Name (DE)" input with "test e2eUpdated extra"
    And I fill out the "Description" input with "test e2eUpdated description"
    And I click on the "Submit" button
    Then I should see "test e2eUpdated extra" text
    And I should see "test e2eUpdated description" text
  ...
  Scenario: Update a Modifier to Extra
    ...
    Then The "Name (HU)" input should contain "test modifier"
    And The chain selector should contain "Rab lánc #1"
    When I fill out the "Name (HU)" input with "test e2eUpdated modifier"
    And I fill out the "Name (EN)" input with "test e2eUpdated modifier"
    And I fill out the "Name (DE)" input with "test e2eUpdated modifier"
    And I fill out the "Description" input with "test e2eUpdated description"
    And I click on the first "Delete" button
    And I click the component selector to set "test component e2eUpdated 1"
    And I click on the "Add" button
    And I click on the "Submit" button
    Then I should see "test e2eUpdated modifier" text
    And I should see "test e2eUpdated description" text
