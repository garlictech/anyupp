...
import { GeneratedProductCollectionService } from '@bgap/admin/refactor';
import {
...
describe('GeneratedProductCollectionService test', () => {
  let service: GeneratedProductCollectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(GeneratedProductCollectionService);
  });
