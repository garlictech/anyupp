...
import { AdminUserCollectionService } from '@bgap/admin/refactor';
import {
...
describe('AdminUserCollectionService test', () => {
  let service: AdminUserCollectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(AdminUserCollectionService);
  });
