...
import {
  ...
  NbSelectModule, NbTabsetModule, NbUserModule
} from '@nebular/theme';
import { TranslateModule } from '@ngx-translate/core';

import {
  ModifiersAndExtrasListComponent
} from './components/modifiers-and-extras-list/modifiers-and-extras-list.component';
...
} from './components/product-component-list-item/product-component-list-item.component';
import {
  ProductComponentSetFormComponent
} from './components/product-component-set-form/product-component-set-form.component';
import {
  ProductComponentSetListItemComponent
} from './components/product-component-set-list-item/product-component-set-list-item.component';
