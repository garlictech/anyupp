...
import { ChainCollectionService } from '@bgap/admin/refactor';
import {
...
describe('ChainCollectionService test', () => {
  let service: ChainCollectionService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(ChainCollectionService);
  });
