Feature: Chain product
  ...
  Scenario: Add new chain product
    ...
    And I select the "Extra comp set" in the modifier selector
    And I click on the "Add" button
    And I select the "Modifier comp set" in the modifier selector
    And I click on the "Add" button
  ...
  Scenario: Update chain product
    ...
    Then The "Name (HU)" input should contain "test product"
    And The category selector should contain "Test product category #2 name"
    When I fill out the "Name (HU)" input with "test e2eUpdated product"
    And I fill out the "Name (EN)" input with "test e2eUpdated product"
    And I fill out the "Name (DE)" input with "test e2eUpdated product"
    ...
    And I click on the "Is visible" checkbox
    And I fill out the "Variant name (HU)" input with "test e2eUpdated variant"
    And I fill out the "Variant name (EN)" input with "test e2eUpdated variant"
    And I fill out the "Variant name (DE)" input with "test e2eUpdated variant"
    ...
    And I click on the "Submit" button
    Then I should see "test e2eUpdated product" text
