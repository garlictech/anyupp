...
export class ProductComponentSetCollectionService extends BaseCollectionService<CrudApi.ProductComponentSet> {
  constructor(
    private _store: Store,
    serviceElementsFactory: EntityCollectionServiceElementsFactory,
    crudSdk: CrudSdkService,
  ) {
    super(ENTITY_NAME.PRODUCT_COMPONENT_SET, serviceElementsFactory, crudSdk);
  }
