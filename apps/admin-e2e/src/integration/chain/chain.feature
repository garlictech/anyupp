Feature: Create a new Chain
  ...
  Scenario: Create new chain
    ...
    When I click on the "Background (light)" picker fill out with "#ffaeec"
    And I fill out the "Phone" input with "1234567890"
    And I click on the "Background (dark)" picker fill out with "#ffaeec"
    And I fill out the "Title" input with "test title"
    And I click on the "Text (light)" picker fill out with "#ffaeec"
    And I fill out the "Country" input with "Hungary"
    And I click on the "Text (dark)" picker fill out with "#ffaeec"
    And I click on the "Border (light)" picker fill out with "#ffaeec"
    And I fill out the "Postal code" input with "1021"
    And I click on the "Border (dark)" picker fill out with "#ffaeec"
    And I fill out the "City" input with "Budapest"
    And I click on the "Highlight" picker fill out with "#ffaeec"
  ...
  Scenario: Update the Chain and the activity
    When I click on the first Edit button
    And I fill out the "Name" input with "test chain updated"
    And I fill out the "Description (HU)" input with "test descripton updated"
    ...
    And I click on the "Background (light)" picker fill out with "#c0c0c0"
    And I fill out the "Phone" input with "1234567890123"
    And I click on the "Background (dark)" picker fill out with "#c0c0c0"
    And I fill out the "Title" input with "test title updated"
    And I click on the "Text (light)" picker fill out with "#c0c0c0"
    And I fill out the "Country" input with "Hungary"
    And I click on the "Text (dark)" picker fill out with "#c0c0c0"
    And I click on the "Border (light)" picker fill out with "#c0c0c0"
    And I fill out the "Postal code" input with "1021"
    And I click on the "Border (dark)" picker fill out with "#c0c0c0"
    And I fill out the "City" input with "Budapest"
    And I click on the "Highlight" picker fill out with "#c0c0c0"
    And I fill out the "Address" input with "Kis u. 42."
    And I click on the "Indicator" picker fill out with "#c0c0c0"
    And I click on the "Disabled" picker fill out with "#c0c0c0"
    And I click on the "Locate on map" button
    And I click on the submit button
    Then I should see "test chain updated" text
