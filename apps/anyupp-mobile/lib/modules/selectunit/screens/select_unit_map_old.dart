...
class SelectUnitByLocationOldScreen extends StatefulWidget {
  @override
  _SelectUnitByLocationOldScreenState createState() =>
      _SelectUnitByLocationOldScreenState();
}

class _SelectUnitByLocationOldScreenState
    extends State<SelectUnitByLocationOldScreen> {
  ...
  void _onMapCreated(GoogleMapController controller) {
    ...
    // Removed because already initialized in the unit select_unit_map screen
    // _determineUserPositionAndLoadUnits();
  }
