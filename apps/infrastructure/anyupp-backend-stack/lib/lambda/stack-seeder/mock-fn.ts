...
import { EProductType } from 'libs/shared/types/src';
...
export const createTestChainProduct = (
  ...
  pipe(
    API.graphql(
      graphqlOperation(createChainProduct, {
...
export const createTestUnitProduct = (
  ...
  pipe(
    API.graphql(
      graphqlOperation(createUnitProduct, {
