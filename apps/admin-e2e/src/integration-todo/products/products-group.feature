...
Scenario: Check hidden dialog
  ...
  Then the "group products" list is displayed
...
Scenario: Set the tax%
  Given I am on the "Tax (%)" input
  When I fill out with "19"
  And I click on the "submit" button
  Then I should see the product list
  When I click on the same product
  Then I should see the "Tax (%)" input with "19"
...
Scenario: Always variant type
  When I click on the "Price (HUF)" input
  And I fill out with "600"
  And I click on the "submit" button
  Then I should see the first product with "600"

Scenario Outline: Set variant type and set the datas
  When I click on the "Price (HUF)" input
  And I fill out with "600"
  And I click on the "submit" button
  Then I should see the first product with "600"
  ...
  Examples:
      | Type     | Day from   | Day to     | Time from | Time to |
      | Weekly   | Monday     | Tuesday    | 12:00     | 14:00   |
      | Seasonal | 02\02\2021 | 03\02\2021 | 14:00     | 16:00   |